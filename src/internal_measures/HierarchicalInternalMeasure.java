...
public class HierarchicalInternalMeasure extends CommonQualityMeasure {
	...
	public double getMeasure(Hierarchy h) {
		...
		for (Node n : divisionNodes) {
			...
			BasicNode artificialRoot = new BasicNode(Constants.ROOT_ID, null, new LinkedList<Node>(),
					new LinkedList<Instance>(), false);
			...
			Hierarchy artificialHierarchy = new BasicHierarchy(artificialRoot, nodesToCalculateInternalMeasure,
					new HashMap<String, Integer>(), numberOfInstances);
