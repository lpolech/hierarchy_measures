...
public class FlatDaviesBouldin extends CommonQualityMeasure {
	...
	private static final Logger log = LogManager.getLogger(FlatDaviesBouldin.class);
	...
	public double getMeasure(Hierarchy h) {
		...
		if (maxAvgClustersDispersion == (-1) * Double.MAX_VALUE) {
			log.error("FlatDaviesBouldin.getMeasure - the maxAvgClustersDispersion  haven't changed, "
