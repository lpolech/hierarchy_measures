...
public class LeavesPerLevelTest {
    ...
    public void singleHierarchyCalculate() throws Exception {
        ...
        assertArrayEquals(new double[]{0.0, 1.0, 1.0}, this.measure.calculate(h), TestCommon.DOUBLE_COMPARISION_DELTA);
    }
    ...
    public void testGetMeasureForHierarchyWithEmptyNodes()
    {
        ...
        assertArrayEquals(new double[]{0.0, 0.0, 0.0, 1.0}, this.measure.calculate(h), TestCommon.DOUBLE_COMPARISION_DELTA);
    }
